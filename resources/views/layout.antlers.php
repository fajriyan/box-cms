...
<head>
  ...
  <meta name="robots" content="{{ if robots }}
            {{ robots }}
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="/assets/static/favicon.png" />
  <link rel="apple-touch-icon-precomposed" sizes="180x180" href="/assets/static/favicon.png" />
  ...
  <meta property="og:image" content="{{ if meta_featured_image }}{{
        meta_featured_image
      }}{{ else }}Fallback Image{{ /if }}" />
  {{ else }}
  <meta property="og:image" content="{{ if meta_featured_image }}{{ config:app.url | trim('/') }}{{
        meta_featured_image
      }}{{ else }}Fallback Image{{ /if }}" />
  {{ /if }}
  ...
  {{ else }}
  <meta property="twitter:image" content="{{ if meta_featured_image }}{{ config:app.url | trim('/') }}{{
        meta_featured_image
      }}{{ else }}Fallback Image{{ /if }}" />
  {{ /if }}
