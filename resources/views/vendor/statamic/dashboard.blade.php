...
<div class="widgets @container flex flex-wrap -mx-4 py-2 ">
   <div class="card card-lg p-10 text-css-cp content w-full ">
      ...
      <div class="flex gap-7">
         <div class="mt-10">
            <h3 class="text-xl text-slate-600">Find me somewhere else</h3>
            <div class="flex gap-3 items-center">
               <a href="https://fajriyan.pages.dev/">
                  <svg class="w-8 h-8 text-slate-600 dark:text-white" aria-hidden="true"
         ...
         <div class="mt-10">
            <h3 class="text-xl text-slate-600">Github Statistics</h3>
            <div class="flex gap-2">
               <img alt="GitHub last commit"
                  src="https://img.shields.io/github/last-commit/fajriyan/box-cms?label=last%20update">
