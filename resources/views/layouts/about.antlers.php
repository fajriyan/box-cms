<div class="">
  <section class="bg-white dark:bg-gray-900">
    <div
      class="grid container mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12"
    >
      <div class="mr-auto place-self-center lg:col-span-7">
        ...
        <a
          href="#"
          class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-slate-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
        >
          Get started
          <svg
  ...
  <section class="bg-white dark:bg-gray-900 my-[100px]">
    <div class="container mx-auto">
      <div class="mx-auto container text-left mb-8 lg:mb-16">
        <h2
  ...
  <section class="bg-white px-4 py-8 antialiased dark:bg-gray-900 md:py-16">
    <div
      class="container mx-auto grid rounded-lg bg-gray-50 p-4 dark:bg-gray-800 md:p-8 lg:grid-cols-12 lg:gap-8 lg:p-16 xl:gap-16"
    >
      ...
      <div class="me-auto place-self-center lg:col-span-7">
        ...
        <a
          href="#"
          class="inline-flex items-center justify-center rounded-lg bg-slate-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
        >
          Pre-order now
        </a>
      </div>
